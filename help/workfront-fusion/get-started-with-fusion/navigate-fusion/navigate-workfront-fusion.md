...
| Insights <br> ![Insights icon](assets/insights-icon.png) | Here, you can see a dashboard of execution metrics for your organization, such as which scenarios are running the most, where delays are occurring, and how effectively your worker pools are operating. | [View the Insights dashboard for an organization](/help/workfront-fusion/set-up-and-manage-workfront-fusion/set-up-and-manage-orgs-and-teams/set-up-orgs-teams-and-users/view-insights-dashboard.md) |
| Team overview  <br> ![Team icon](assets/team-icon.png) | Here, you can see information about Fusion teams, such as the number of operations performed by scenarios in this team and a list of active scenarios. You can also view and manage the users on this team. When viewing a team, you can select a different team from a dropdown at the top of this page.<br>The currently selected team displays above this icon.<br>You may need to create a team before you can see the team overview or any of the team sections listed in this article. | [Organizations and teams](/help/workfront-fusion/set-up-and-manage-workfront-fusion/set-up-and-manage-orgs-and-teams/set-up-orgs-teams-and-users/org-and-team-overview.md) |
...
| Functions <br> ![Functions icon](assets/functions-icon.png) | Custom functions are JavaScript functions that can be added to scenarios to manipulate and transform data. <br>Your organization must have a license to Adobe App Builder to create and use custom functions. | [Map data using custom functions](/help/workfront-fusion/create-scenarios/map-data/map-using-custom-functions.md) |
| Packages <br> ![Packages icon](assets/packages-icon.png) | Packages let you build and run your own custom logic inside Fusion, without leaving the Fusion interface. In the Packages area, you can view and manage the packages owned by your team. | [Use custom function packages](/help/workfront-fusion/create-scenarios/map-data/use-custom-function-packages.md) |
| Storage <br> ![Storage icon](assets/storage-icon.png) | Storage gives your team direct access to your Adobe Enterprise Storage Management (ESM) repositories. You can browse folders, upload and download files, view file version history, and create automation scenarios, all without leaving Fusion. | [Storage overview](/help/workfront-fusion/set-up-and-manage-workfront-fusion/use-workfront-storage/storage-overview.md) |
