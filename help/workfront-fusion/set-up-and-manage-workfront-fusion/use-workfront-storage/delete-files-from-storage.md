...
description: You can delete a file from Storage directly from the file browser.
author: Becky
...
>[!NOTE]
>
>Only files can be deleted. Folder deletion is not supported in this version.
