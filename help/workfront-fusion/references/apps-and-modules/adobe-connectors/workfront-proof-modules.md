...
description: In an Adobe Workfront Fusion scenario, you can automate workflows that use [!DNL Workfront Proof], as well as connect it to multiple third-party applications and services.
author: Becky
...
In an Adobe Workfront Fusion scenario, you can automate workflows that use [!DNL Workfront Proof], as well as connect it to multiple third-party applications and services.

This is useful if you need to execute tasks currently not supported in proofing within Workfront or in [!DNL Workfront Proof], such as updating proofs based on certain events and searching for a proof's recipients.
...
## Connect [!DNL Workfront Proof] to Workfront Fusion 

You can create a connection to your [!DNL Workfront Proof] account directly from inside a Workfront Fusion module.
   ...
   <table style="table-layout:auto"> 
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>The production, preview, or custom environment that you want to connect to.</td>
            </tr>
        </tbody>
    </table>
...
When you configure [!DNL Workfront Proof] modules, Workfront Fusion displays the fields listed below. Along with these, additional [!DNL Workfront Proof] fields might display, depending on factors such as your access level in the app or service. A bolded title in a module indicates a required field.
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>Select whether you want to watch for new proofs, or for new overall proof decisions.</td> 
  </tr> 
  <tr data-mc-conditions=""> 
  ...
  <tr data-mc-conditions=""> 
   <td role="rowheader">Items Per Page</td> 
   <td> <p>To paginate results, enter or map the number of returned results that should appear on each page of results. This number must be less than or equal to 100.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
>**Example:**
>
>![Proof API module example](/help/workfront-fusion/references/apps-and-modules/assets/wfp-api-module-example-350x586.png)
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   <td>[!UICONTROL Deadline]</td> 
   <td> <p>Specify the deadline you want for the proof that is created. Use the date format <code>YYYY-MM-DD hh:mm</code>.</p> </td> 
  </tr> 
  <tr> 
   <td>[!UICONTROL Default email notifications for subscribers]</td> 
  ...
  <tr> 
   <td>[!UICONTROL Enable Subscriptions]</td> 
   <td>Select whether people who are not participants are allowed to subscribe to the proof.<br>If you select this option, you can also select an option in the [!UICONTROL Default Role] field.</td> 
  </tr> 
  <tr> 
   <td>[!UICONTROL Enable Subscriptions Validation]</td> 
   <td>Select whether you want to enable subscription email validation. If this is enabled, the subscriber must click a link in an email to access a proof.</td> 
